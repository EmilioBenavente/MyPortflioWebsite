...
const contents =
	  ...
	  title: '[School Project] Dot Defender Terminal Software',
          body: '<p>Dot Defender was my first <i>final</i> of a school project. It was the third weekend of the first programming class presented at Full Sail University. The assignment was simply to make a terminal-based game. The creative side of me wanted to put a twist on an already existing game. Everybody knows the game Pac-Man, however, have you ever wondered what the game would be like if you played as the antagonist? That\'s right! I\'m talking about playing as one of those ghosts chasing our favorite character. This is exactly the point of Dot Defender. It turned out to be a very interesting project and something I might come back to one day. If you want take a look at how my end product turned out, here is a demo video -> <a href="https://youtu.be/xrjzCTI6wqs" target="_blank">Demo Video</a></p>',
	  ...
	  body: '<p>Steel Light is another school project that represents a game inside a terminal. This game theoretically puts the user inside the atmospheric volume of space. Here, the user controls an object that represents a space ship and attempts to avoid what are meant to be falling asteroids. The game is endless and entirely based on survival. The player that survives for the longest period of time will see their username in a list of high scores. This project actually has an upcoming sequel where the protagonist is named after the high score holder from a list of testers that tested this version of the game. Also, as a note for that record holder, no I haven\'t forgotten, this game WILL be released...I\'ve just been busy...you understand. Now many people can hold me accountable. If anybody is interested in the terminal version, here is a demo of this project -> <a href="https://youtu.be/f4BkYDgvzbQ" target="_blank">Demo Video</a></p>',		   
	  ...
	  body: 'The Cat Fighter Application is a game where the user plays as a cat fighting off monsters. The cat has both a kick ability and a power beam ability that can blast stronger and further depending on how long the user holds the button. The art and level design of this game was pre-made by another developer. However, none of the mechanics such as movement, abilities, damage and player animations were working. These were my assignments for the project. Everything listed above was done through programming in the unity engine. For a full picture as to how the game works I recommend giving this demo video a look. -> <a href="https://youtu.be/0oiHSk7PkEQ" target="_blank">Demo Video</a></p>',		   
      ...
      {
	  id: 10,
	  title: '[School Project] Creating Circuits With Xilinx',
	  body: '<p>For an entire month of school I got the golden opportunity to mess with the Xilinx software. For those that don\'t know what this is, it\'s a program for creating the paths on a circuit board. It allows you to design units within a circuit board such as an adder circuit. Also, if you have heard of Xilinx, you know this software isn\'t cheap and again i\'m super grateful I got to learn in this environment. However, I don\'t have much to show on the topic. The image contains the most complicated circuit I made in this time period. </p>',
	  ...
	  body: '<p>My school followed up the class of Xilinx with the subject of Arduino. Arduino is a company that offers pre-built chips/motherboards usually without software and are ready to be programmed by the user. With these, there are many possibilities for a programmer. Learning how the circuits are designed really adds a bonus into the amount of freedom a programmer has. In my final project for this class, I used a light sensor and a knob to control a display on an LCD screen. Here is a look at my final project -> <a href="https://youtu.be/XyvQFyd48iM" target="_blank">Demo Video</a></p>',
	  ...
	  body: 'I am now a Bachelor graduate of Full Sail University. I am currently looking for jobs in the programming field, but that leap is not as easy as I once thought before. I gradated as a valedictorian in my class and earned a course director award for my Steele Light project shown below. I applied for jobs in a month\’s time with the only feedback being that a website would be helpful. Thus, within 3 weeks I have learned much about web development and made this page with the Vue API as a way to prove my efforts to potential employers. ',		   
